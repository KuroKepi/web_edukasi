            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select name="type" required
                  ...
                  <option value="image" <?= $materi['type'] === 'image' ? 'selected' : '' ?>>Gambar</option>
                  <option value="audio" <?= $materi['type'] === 'audio' ? 'selected' : '' ?>>Audio</option>
              ...
              <div class="md:col-span-1">
                ...
                <div class="w-full bg-gray-50 border border-dashed border-gray-300 rounded-lg p-4">
                  ...
                  <?php if ($materi['file_path']): ?>
                    <p class="text-sm mt-2 text-gray-600"><?= basename($materi['file_path']) ?></p>
                  <?php endif; ?>
                </div>
              </div>
              <div class="md:col-span-1">
                ...
                <div class="w-full bg-gray-50 border border-dashed border-gray-300 rounded-lg p-4">
                  ...
                  <?php if ($materi['thumbnail']): ?>
                    <p class="text-sm mt-2 text-gray-600"><?= basename($materi['thumbnail']) ?></p>
                  <?php endif; ?>
                </div>
              </div>
            </div>
