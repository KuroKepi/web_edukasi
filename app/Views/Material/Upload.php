            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="md:col-span-1">
                ...
                <div class="w-full bg-gray-50 border border-dashed border-gray-300 rounded-lg p-4">
                  <input type="file" name="file" accept=".pdf,.doc,.docx,.ppt,.pptx,.xls,.xlsx,.mp4,.mp3,.wav" class="w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:bg-blue-600 file:text-white hover:file:bg-blue-700">
                </div>
              </div>
              <div class="md:col-span-1">
                <label class="block text-sm font-medium text-gray-700 mb-1">Thumbnail (Gambar Max 10MB)</label>
                <div class="w-full bg-gray-50 border border-dashed border-gray-300 rounded-lg p-4">
                  <input type="file" name="thumbnail" accept="image/*" class="w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:bg-gray-600 file:text-white hover:file:bg-gray-700">
                </div>
              </div>
            </div>
