        ...
        <main class="flex-1 bg-gray-50">
            ...
            <div class="px-6 py-8">
                <div class="bg-white rounded-xl shadow p-8 max-w-4xl mx-auto">
                    ...
                    <form action="<?= base_url('user/update/' . $user['id']) ?>" method="post" class="space-y-8">
                        <?= csrf_field() ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Password Baru <small
                                        class="text-gray-500">(Opsional)</small></label>
